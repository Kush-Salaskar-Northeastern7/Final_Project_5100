...
public class CustomerDirectory {
    ...
    public Customer addCustomer(String name, int age, String address, String community, String zip, String img, long phoneNum, int glucLvl, String diabetesType, UserAccount ua){
